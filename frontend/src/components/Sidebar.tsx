  ...
  return (
    <aside className="sidebar">
      ...
      <nav className="sidebar-nav">
        ...
        <button
          className={`sidebar-nav-item ${activeItem === 'work' ? 'active' : ''}`}
          onClick={() => handleNavigation('work', undefined, 'Work')}
        >
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button
          className={`sidebar-nav-item ${activeItem === 'personal' ? 'active' : ''}`}
          onClick={() => handleNavigation('personal', undefined, 'Personal')}
        >
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button
          className={`sidebar-nav-item ${activeItem === 'ideas' ? 'active' : ''}`}
          onClick={() => handleNavigation('ideas', undefined, 'Ideas')}
        >
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <button
          className={`sidebar-nav-item ${activeItem === 'archived' ? 'active' : ''}`}
          onClick={() => handleNavigation('archived', undefined, 'Archived')}
        >
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
